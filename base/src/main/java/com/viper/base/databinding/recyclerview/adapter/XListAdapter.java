...
public abstract class XListAdapter<T, VH extends RecyclerView.ViewHolder>
    ...
    protected XListAdapter(@NonNull DiffUtil.ItemCallback<T> diffCallback) {
        mDiffer = new XAsyncListDiffer<>(new AdapterListUpdateCallback(this),
            new AsyncDifferConfig.Builder<>(diffCallback).build());
        mDiffer.addListListener(mListener);
    }

    @SuppressWarnings("unused")
    protected XListAdapter(@NonNull AsyncDifferConfig<T> config) {
        mDiffer = new XAsyncListDiffer<>(new AdapterListUpdateCallback(this), config);
        mDiffer.addListListener(mListener);
    }
