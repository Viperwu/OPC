...
public abstract class BaseDataBindingAdapter<M, B extends ViewDataBinding> extends XListAdapter<M, RecyclerView.ViewHolder> {
    ...
    public interface OnItemLongClickListener<M> {
        void onItemLongClick(View view, M item, int position);
    }
}
