...
public enum BuiltinDataType {
    ...
    ExpandedNodeId(18, com.viper.opc.client.opcua.stack.core.types.builtin.ExpandedNodeId.class),
    StatusCode(19, StatusCode.class),
    QualifiedName(20, QualifiedName.class),
    LocalizedText(21, com.viper.opc.client.opcua.stack.core.types.builtin.LocalizedText.class),
    ExtensionObject(22, ExtensionObject.class),
    DataValue(23, com.viper.opc.client.opcua.stack.core.types.builtin.DataValue.class),
    Variant(24, Variant.class),
    DiagnosticInfo(25, com.viper.opc.client.opcua.stack.core.types.builtin.DiagnosticInfo.class);
